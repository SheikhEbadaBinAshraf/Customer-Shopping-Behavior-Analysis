...
--Q2. which customers used discount but still spent more than the
...
--Q5.Do subscribed customers spent more?
...
-- based on their total numbers of previous purchses,
